...
class TranslationMenu(BaseMenuModule):
    ...
    def get_usage_examples(self) -> List[str]:
        ...
        return [
            ...
            "uv run python scripts/translation/integrate_translation.py \\",
            "  --input data/validation_balanced.jsonl \\",
            "  --output data/validation_balanced_en.jsonl \\",
            "  --cache",
            "",
            "# Run validation with automatic translation",
            "uv run python scripts/translation/validate_with_translation.py",
            "",
            "# Translate documents with Ollama",
            "uv run python scripts/translation/translate_documents_ollama.py \\",
