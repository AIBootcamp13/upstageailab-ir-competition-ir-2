...
class DataManagementMenu(BaseMenuModule):
    ...
    def get_usage_examples(self) -> List[str]:
        ...
        return [
            ...
            f"PYTHONPATH=src uv run python scripts/maintenance/reindex.py {self.get_current_documents_path()}",
            "",
            "# Analyze document datasets",
            "PYTHONPATH=src uv run python scripts/data/analyze_data.py",
            "",
            "# Check for duplicate entries",
            "PYTHONPATH=src uv run python scripts/data/check_duplicates.py",
        ]
