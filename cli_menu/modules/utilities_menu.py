...
class UtilitiesMenu(BaseMenuModule):
        ...
        return {
            "Utilities": [
                ...
                },
                {
                    ...
                    "command": "PYTHONPATH=src uv run python scripts/indexing/switch_config.py polyglot-3b",
                ...
                },
                {
                    ...
                    "command": "PYTHONPATH=src uv run python scripts/indexing/switch_config.py polyglot-1b",
                ...
                },
                {
                    ...
                    "command": "uv run streamlit run scripts/visualization/visualize_submissions.py",
    ...
    def get_setup_instructions(self) -> str:
        ...
        if not validation["streamlit_available"]:
            ...
            instructions.append("   Run: uv add streamlit")
        ...
        if validation["config_switcher_available"] and validation["settings_file_exists"]:
            ...
            instructions.append("   Use: PYTHONPATH=src uv run python scripts/indexing/switch_config.py [korean|english|bilingual|solar|show]")
    ...
    def get_usage_examples(self) -> List[str]:
        ...
        return [
            ...
            "PYTHONPATH=src uv run python scripts/indexing/switch_config.py show",
            "",
            "# Switch configurations",
            "PYTHONPATH=src uv run python scripts/indexing/switch_config.py korean    # Korean (768D)",
            "PYTHONPATH=src uv run python scripts/indexing/switch_config.py english   # English (384D)",
            "PYTHONPATH=src uv run python scripts/indexing/switch_config.py bilingual # Bilingual (768D)",
            "PYTHONPATH=src uv run python scripts/indexing/switch_config.py solar     # Solar API (4096D)",
            "",
            "# Clean up distributions",
            "./scripts/infra/cleanup-distros.sh",
            "",
            "# Launch Streamlit UI",
            "uv run streamlit run scripts/visualization/visualize_submissions.py",
        ]
